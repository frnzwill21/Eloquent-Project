...
<div class="max-w-2xl mx-auto bg-dark-800 rounded-2xl shadow-xl border border-gray-700/50 overflow-hidden backdrop-blur-md">
    <div class="p-6 border-b border-gray-700 bg-dark-900">
        <h2 class="text-xl font-bold text-white">Tambah Data Karyawan</h2>
    </div>
    ...
    <div class="p-6">
        ...
        <form action="{{ route('karyawan.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama" id="nama" class="w-full bg-dark-900 text-gray-200 border border-gray-600 focus:border-emerald-500 focus:ring focus:ring-emerald-500/20 rounded-lg py-2.5 px-4 outline-none transition-all" value="{{ old('nama') }}" required>
            </div>

            <div class="mb-5">
                <label for="posisi" class="block text-sm font-medium text-gray-300 mb-2">Posisi</label>
                <input type="text" name="posisi" id="posisi" class="w-full bg-dark-900 text-gray-200 border border-gray-600 focus:border-emerald-500 focus:ring focus:ring-emerald-500/20 rounded-lg py-2.5 px-4 outline-none transition-all" value="{{ old('posisi') }}" required>
            </div>
